# Settings for CapAlertBridge and PongBot
...
WELCOME_MSG = 'CapAlertBridge, here for you like a friend who is not. Try sending: ping @foo  or, CMD? for more'
EMERGENCY_RESPONSE = "CapAlertBridge detected a possible request for Emergency Assistance and alerted a wider audience."
...
try:
    ...
    qrz_hello_string = config['qrz'].get('qrz_hello_string', 'CapAlertBridge says Hello! DM for more info.')
