# cap-ipaws-bridge modules/dxspot.py - Handles DX Spotter integration
...
def get_spothole_spots(source=None, band=None, mode=None, date=None, dx_call=None, de_continent=None, de_location=None):
    ...
    try:
        headers = {"User-Agent": "cap-ipaws-bridge-dxspotter/1.0"}
...
def post_spothole_spot(spot):
    ...
    headers = {"Content-Type": "application/json", "User-Agent": "cap-ipaws-bridge-dxspotter/1.0"}
    try:
