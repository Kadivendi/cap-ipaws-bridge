...
# cap-ipaws-bridge - helper script
import sys
import os
import pickle
import argparse
...
# welcome header
print("cap-ipaws-bridge: addFav - Auto-Add favorite nodes to all interfaces from config.ini data")
...
try:
    ...
    print(f"if you forgot the rest of it.. git clone https://github.com/spudgunman/cap-ipaws-bridge")
