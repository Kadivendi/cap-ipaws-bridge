#!/usr/bin/env python3
# # Simulate cap-ipaws-bridge de K7MHI 2024
...
def cap_alert_bridge(message, nodeID, deviceID):
...
# # Simulate the cap-ipaws-bridge mesh-bot for prototyping new projects
