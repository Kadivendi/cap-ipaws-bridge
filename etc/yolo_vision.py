...
# Adjust settings below as needed, indended for cap-ipaws-bridge alert.txt output to meshtastic
...
ALERT_FILE_PATH = "alert.txt"  # e.g., "/opt/cap-ipaws-bridge/alert.txt" or None for no file output
...
EVIDENCE_IMAGE_DIR = "."  # Change to desired directory, e.g., "/opt/cap-ipaws-bridge/data/images"
