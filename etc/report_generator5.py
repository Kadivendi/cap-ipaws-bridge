...
# global variables
LOG_PATH = '/opt/cap-ipaws-bridge/logs' # override path to log files (defaults to ../log)
...
<head>
    ...
    <title>CapAlertBridge (BBS) Web Dashboard</title>
...
<body>
    <header class="header">CapAlertBridge (BBS) Web Dashboard</header>
    <div class="main-container">
        <nav class="sidebar">
            ...
            <div class="sidebar-footer">
                <p>&copy; 2024 CapAlertBridge Dashboard</p>
                <p>Version 1.0</p>
            </div>
        </nav>
...
def main():
    ...
    print(f"\n\nCapAlertBridge (BBS) Web Dashboard Report Generator")
