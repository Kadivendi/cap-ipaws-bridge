#!/bin/bash
# CapAlertBridge Update Script
# Usage: bash update.sh or ./update.sh after making it executable with chmod +x update.sh

echo "=============================================="
echo "     CapAlertBridge Automated Update & Backup Tool    "
echo "=============================================="
echo

# --- Service Management ---
service_stopped=false
for svc in cap_alert_bridge.service pong_bot.service cap_alert_bridge_reporting.service cap_alert_bridge_w3.service; do
...
echo
echo "=============================================="
echo "      CapAlertBridge Update Completed Successfully!   "
echo "=============================================="
exit 0
# End of script